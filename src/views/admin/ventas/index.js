...
import ListaCajaModuleDetails from './components/listaCajaDetalles';
...
const VentasModule = () => {
  ...
  if (loading) {
    ...
    return (
      <Redirect className="text-light" to={process.env.PUBLIC_URL + '/'} />
    );
  } else {
    return (
      <>
