        ...
        await axios
          ...
          .then((res) => {
            ...
            if (status === 200) {
              ...
              setActividadStr(
                "El usuario ha eliminado el cliente '" + name + "'",
              );
          ...
          .catch(() => {
            ...
            setMsgStrong('Hubo un error!');
            setMsgGralAlert(
              ' Controle que el cliente no tenga nada cargado en su cuenta corriente',
            );
            setSuccessAlert(false);
            setAlertar(!alertar);
          });
        ...
        <UncontrolledDropdown>
          ...
          <DropdownMenu className="dropdown-menu-arrow" right>
            ...
            <DropdownItem
              href="#pablo"
              onClick={(e) =>
                EliminarOff(e, item.id, item.razsoc, primero, pagina)
              }
            >
